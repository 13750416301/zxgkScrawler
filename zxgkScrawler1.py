...
if __name__ == "__main__":
    ...
    headers = {
        ...
        'Cookie': 'JSESSIONID=1117B4BC0F5FBD9E0027A7C4542DCF05; _gscu_15322769=57994001imyfys20; SESSION=8a89a2ba-66fc-4700-916b-64cf745d6171; Hm_lvt_d59e2ad63d3a37c53453b996cb7f8d4e=1558834041,1558923029,1559009549,1559095425; _gscbrs_15322769=1; Hm_lpvt_d59e2ad63d3a37c53453b996cb7f8d4e=1559096204; _gscs_15322769=5909542610tvxi12|pv:4',
        'Host': 'zxgk.court.gov.cn',
        'Referer': 'http://zxgk.court.gov.cn/index.jsp',
    ...
    for page in range(1, 113):
        ...
        web2 = web2.encode()
        with open('json\jsonArray' + str(page) +  '.json', 'wb') as jsonFile:
            jsonFile.write(web2)
        jsonFile.close()
        
        with open('json\jsonArray' + str(page) +  '.json', "r", encoding='utf-8') as jsonFile:
        ...
        print('Page: ' + str(page))
        with open('json\jsonPage' + str(page) + '.json', 'wb') as jsonFile:
